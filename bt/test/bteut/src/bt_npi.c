...
int bt_address_write(const char *addr, char *rsp)
{
    ...
    fd = open("/mnt/vendor/btmac.txt", O_RDWR | O_CREAT, 0666);
    if(fd < 0)
    {
    ...
    if (-1 == chmod("/mnt/vendor/btmac.txt", 0666))
    ...
    fd = open("/data/vendor/bluetooth/btmac.txt", O_RDWR | O_CREAT, 0666);
    if(fd < 0)
    {
    ...
    {
        if (-1 == chmod("/data/vendor/bluetooth/btmac.txt", 0666))
