 ...
 *
 ******************************************************************************/
#ifndef BT_LIBBT_CONF_SPRD_MARLIN_INCLUDE_MARLIN_H_
#define BT_LIBBT_CONF_SPRD_MARLIN_INCLUDE_MARLIN_H_

#include "bt_vendor_sprd.h"

#define PSKEY_PRELOAD_SIZE 0x04
#define PSKEY_PREAMBLE_SIZE 0xDA
...
typedef struct {
    ...
    uint16_t  g_central_or_peripheral;
} pskey_config_t;

const bt_adapter_module_t *get_adapter_module(void);

#endif  // BT_LIBBT_CONF_SPRD_MARLIN_INCLUDE_MARLIN_H_
