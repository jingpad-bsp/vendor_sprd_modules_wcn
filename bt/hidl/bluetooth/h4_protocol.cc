...
size_t H4Protocol::Send(uint8_t type, const uint8_t* data, size_t length) {
  ...
  btsnoop_sprd_for_raw_get_interface()->capture_for_raw(type,data,0);
...
void H4Protocol::OnPacketReady() {
  ...
  btsnoop_sprd_for_raw_get_interface()->capture_for_raw(hci_packet_type_,event.data(),1);
