...
bool BluetoothAudioSession::UpdateAudioConfig(
  ...
  if (!is_software_audio_config && !is_offload_audio_config) {
  	LOG(ERROR) << __func__ << "BluetoothAudioSession UpdateAudioConfig ERROR";
    return false;
  }
...
const AudioConfiguration& BluetoothAudioSession::GetAudioConfig() {
  ...
  if (IsSessionReady()) {
    return audio_config_;
  	...
  	LOG(INFO) << __func__ << "return failed kInvalidOffloadAudioConfiguration" ;
    return kInvalidOffloadAudioConfiguration;
  } else {
  	LOG(ERROR) << __func__ << " QUAN GetAudioConfig ,return failed kInvalidSoftwareAudioConfiguration" ;
